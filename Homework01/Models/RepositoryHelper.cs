namespace Homework01.Models
{
	public static class RepositoryHelper
	{
		...
		public static sysdiagramRepository GetsysdiagramRepository(IUnitOfWork unitOfWork)
		{
			var repository = new sysdiagramRepository();
		...
		public static vw_CustomerOverViewRepository Getvw_CustomerOverViewRepository()
		{
			var repository = new vw_CustomerOverViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerOverViewRepository Getvw_CustomerOverViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerOverViewRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
